...
## This project addresses a critical need for standardized documentation of clinical NLP data. The framework supports dataset discovery and reuse for the AMIA NLP community and establishes a foundation for reproducible clinical NLP research. {#this-project-addresses-a-critical-need-for-standardized-documentation-of-clinical-nlp-data.-the-framework-supports-dataset-discovery-and-reuse-for-the-amia-nlp-community-and-establishes-a-foundation-for-reproducible-clinical-nlp-research. .unnumbered}

## **1.2 Scope Definition** {#scope-definition .unnumbered}
...
## **1.3 Dual Deliverable Strategy** {#dual-deliverable-strategy .unnumbered}
...
## Unlike bibliographic databases such as PubMed or Scopus, major clinical NLP data repositories offer limited support for structured Boolean queries. Consequently, dataset identification relied on platform-specific strategies, including free-text keyword searches, category-based filtering using platform taxonomies, manual review of shared task collections, and iterative expansion guided by expert advice within the AMIA NLP Working Group. {#unlike-bibliographic-databases-such-as-pubmed-or-scopus-major-clinical-nlp-data-repositories-offer-limited-support-for-structured-boolean-queries.-consequently-dataset-identification-relied-on-platform-specific-strategies-including-free-text-keyword-searches-category-based-filtering-using-platform-taxonomies-manual-review-of-shared-task-collections-and-iterative-expansion-guided-by-expert-advice-within-the-amia-nlp-working-group. .unnumbered}

## Six predefined concept-level categories guided the search process:  {#six-predefined-concept-level-categories-guided-the-search-process .unnumbered}
...
## **2.2 Community contribution and feedback** {#community-contribution-and-feedback .unnumbered}
...
# **3. Screening and Eligibility Criteria** {#screening-and-eligibility-criteria .unnumbered}
...
# **4. Metadata Framework Development** {#metadata-framework-development .unnumbered}

## **4.1 FAIR Principles Alignment** {#fair-principles-alignment .unnumbered}
...
## **4.2 Comprehensive Metadata Variables** {#comprehensive-metadata-variables .unnumbered}
...
## **5.1 Primary Abstraction** {#primary-abstraction .unnumbered}
...
## **5.2 Consolidation and Cleaning** {#consolidation-and-cleaning .unnumbered}
...
## **5.3 Data Cleaning Phase** {#data-cleaning-phase .unnumbered}
...
# **6. Quality Assurance Process** {#quality-assurance-process .unnumbered}

## **6.1 Double Review Strategy** {#double-review-strategy .unnumbered}
...
## **6.2 Agreement Analysis** {#agreement-analysis .unnumbered}
...
## **6.3 Adjudication Plan** {#adjudication-plan .unnumbered}
...
# **7. Community Repository and Maintenance** {#community-repository-and-maintenance .unnumbered}

## **7.1 GitHub Repository Structure** {#github-repository-structure .unnumbered}
...
## **7.2 Community Contribution Model** {#community-contribution-model .unnumbered}
...
## **7.3 Governance and Maintenance** {#governance-and-maintenance .unnumbered}
...
# **8. Appendices** {#appendices .unnumbered}

## Appendix A: Quality Check Instructions for Reviewers {#appendix-a-quality-check-instructions-for-reviewers .unnumbered}
...
## Appendix B: Version History {#appendix-b-version-history .unnumbered}
